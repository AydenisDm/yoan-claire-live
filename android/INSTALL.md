...
**This build:** debug, application id `com.eventview.app.debug`, version `1.0.3-debug`

The debug APK built for this run is named:

`eventview_1_0_3_debug.apk`

## 1. Get the APK onto Windows

1. Download `eventview_1_0_3_debug.apk` from the GitHub prerelease, or from whoever sent you the file.
...
2. On the device, open **Files** (or Drive) and tap `eventview_1_0_3_debug.apk`.
...
adb devices
adb install -r eventview_1_0_3_debug.apk
```
